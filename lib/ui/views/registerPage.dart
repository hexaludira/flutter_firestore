                ...
                SliverFillRemaining(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        Text(
                          'Already have account?', style: TextStyle(color: Colors.white),
                        ),
                        GestureDetector(
                          onTap: () {
                          ...
                          child: Text(
                            'Login Here', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w700),
                          ),
                        ),
                      ],
                    ),
